          ...
          <div className="left-content-area">
            ...
            <section className="funil-vendas-container">
              ...
              <div className="funil-steps">
                <div className="funil-step active">Leads</div>
                <div className="funil-step">Contato Feito</div>
                <div className="funil-step">Visitas Agendadas</div>
                <div className="funil-step">Propostas</div>
                <div className="funil-step">Fechados</div>
              </div>
              ...
              <div className="sidebar-padding">
                ...
                <div className="interaction-timeline">
                  <div className="timeline-item">
                    ...
                    <p>Cliente perguntou sobre condomínio via WhatsApp.</p>
                  </div>
                  <div className="timeline-item">
